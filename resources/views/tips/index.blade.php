                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row mt-3">
                                            <div class="col">
                                                <input type="text" class="form-control" placeholder="Judul Tips">
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col">
                ...
                <table class="table table-light table-striped text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>13.00</td>
                            <td>
                                <button style="border: none" data-bs-toggle="modal" data-bs-target="#editTips">
                                ...
                                <div class="modal fade" id="editTips" tabindex="-1" aria-labelledby="editTipsLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="editTipsLabel"
                                                    style="font-weight: bold; color: rgba(59, 75, 101, 1);">
                                                    Edit Tips</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                ...
                                <div class="modal fade" id="hapusBerita" tabindex="-1"
                                    aria-labelledby="hapusBeritaLabel" aria-hidden="true">
